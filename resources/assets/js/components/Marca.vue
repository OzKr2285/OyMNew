    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Gestión de Marcas 
          <button
            type="button"
            ...
            <div class="col-md-6">
              <div class="input-group">
                ...
                <input
                  type="text"
                  v-model="buscar"
                  @keyup.enter="listarDatos(1,buscar,criterio)"
                  class="form-control"
            ...
            <tbody>
              <tr v-for="objeto in arrayDatos" :key="objeto.id">
                ...
                <td>
                  ...
                  <md-button class="md-icon-button md-primary " @click="eliminarMarca(objeto)" title="Eliminar">
            ...
            <form method="post" enctype="multipart/form-data" class="form-horizontal">
              <md-card-content>
                <md-field :class="getValidationClass('nombre')">
                  ...
                  >Olvidaste asignar el nombre de la Marca</span>
    ...
    listarDatos(page, buscar, criterio) {
      ...
      axios
        ...
        .then(function(response) {
          ...
          me.arrayDatos = respuesta.marca.data;
