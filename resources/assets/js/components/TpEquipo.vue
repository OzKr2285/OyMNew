    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Tipo Equipo  
          <button
            type="button"
            @click="abrirModal('tpequipo','registrar')"
        ...
        <div class="card-body">
            ...
            <div class="col-md-6">
              <div class="input-group">
                ...
                <input
                  type="text"
                  v-model="buscar"
                  @keyup.enter="listarTpEquipo(1,buscar,criterio)"
                  class="form-control"
                  placeholder="Texto a buscar"
                >
                <button
                  type="submit"
                  @click="listarTpEquipo(1,buscar,criterio)"
          ...
          <table class="table table-bordered table-striped table-sm">
            ...
            <tbody>
              <tr v-for="objeto in arrayTpEquipo" :key="objeto.id">
                <td v-text="objeto.nombre"></td>
                <td v-text="objeto.descripcion"></td>

                <td>
                  <md-button class="md-icon-button " @click="abrirModal('tpequipo','actualizar',objeto)" title="Actualizar">                         
                    <i class="material-icons Color3">edit</i>
                  </md-button>
                  <md-button class="md-icon-button md-primary " @click="eliminarTpEquipo(objeto)" title="Eliminar">
            ...
            <form action method="post" enctype="multipart/form-data" class="form-horizontal">
              <md-card-content>
                <md-field :class="getValidationClass('nombre')">
                  ...
                  >El nombre del tipo de Equipo es requerido</span>
...
export default {
  ...
  methods: {
   ...
   getTpEquipo() {
    ...
    listarTpEquipo(page, buscar, criterio) {
      let me = this;
      var url =
        "/tpequipo?page=" +
        page +
      ...
      axios
        ...
        .then(function(response) {
          var respuesta = response.data;
          me.arrayTpEquipo = respuesta.tpequipo.data;
    ...
    cambiarPagina(page, buscar, criterio) {
      ...
      me.listarTpEquipo(page, buscar, criterio);
    },
    registrarTpEquipo() {
  ...
  mounted() {
    ...
    this.listarTpEquipo(1, this.buscar, this.criterio);
  }
};
</script>
<style>
