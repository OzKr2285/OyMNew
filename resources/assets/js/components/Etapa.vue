    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Gestión de Etapas
          <button
            type="button"
          ...
          <template v-if="listado==1">
            <div class="md-layout">
              ...
              <div class="md-layout-item">
                <md-field md-clearable>
                  ...
                  <md-input v-model="buscar" @keypress="listarEtapa(1,buscar,criterio)"></md-input>
                </md-field>
              </div>&nbsp;&nbsp;&nbsp;
              <div class="md-layout-item">
                <br />
                <md-button class="md-icon-button md-dense md-raised md-primary" @click="listarEtapa(1,buscar,criterio)">
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped table-sm">
                ...
                <tbody>
                  <tr v-for="objeto in arrayEtapa" :key="objeto.id">
            ...
            <div class="card-body">
              <form action method="post" enctype="multipart/form-data" class="form-horizontal">
                <md-card-content>
                  ...
                  <div class="md-layout">
                    <md-field :class="getValidationClass('descripcion')" md-clearable>
