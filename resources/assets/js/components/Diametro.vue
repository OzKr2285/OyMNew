    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Gestión de Diámetros 
          <button
            type="button"
        ...
        <div class="card-body">
            ...
            <div class="col-md-6">
              <div class="input-group">
                ...
                <input
                  type="text"
                  v-model="buscar"
                  @keyup.enter="listarDiametro(1,buscar,criterio)"
                  class="form-control"
                  placeholder="Texto a buscar"
                >
                <button
                  type="submit"
                  @click="listarDiametro(1,buscar,criterio)"
          ...
          <table class="table table-bordered table-striped table-sm">
            ...
            <tbody>
              <tr v-for="objeto in arrayDiametro" :key="objeto.id">
                ...
                <td>
                  ...
                  <md-button class="md-icon-button md-primary " @click="eliminarDiametro(objeto)" title="Eliminar">
...
export default {
  ...
  methods: {
    ...
    listarDiametro(page, buscar, criterio) {
      let me = this;
      var url =
        "/diametro?page=" +
        page +
      ...
      axios
        ...
        .then(function(response) {
          ...
          me.arrayDiametro = respuesta.diametro.data;
    ...
    actualizarDiametro() {
      ...
      axios
        ...
        .then(function(response) {
          me.cerrarModal();
          me.listarDiametro(1, "", "nombre");
          me.mensaje("Actualizado", "Actualiz� ");
        })
        .catch(function(error) {
          console.log(error);
        });
    ...
    eliminarDiametro(data = []) {
      swal({
        ...
        if (result.value) {
          let me = this;
          this.idDiametro = data["id"];
          axios
            .post("/diametro/eliminar", {
              id: this.idDiametro
            })
            .then(function(response) {
              me.cerrarModal();
              me.listarDiametro(1, "", "nombre");
              me.mensaje("Eliminado", "Elimin� ");
            })
            .catch(function(error) {
              console.log(error);
            });
    ...
    mensaje(tipo, crud) {
      swal(tipo, "El registro se " + crud + " con �xito.", "success");
    },
      ...
      switch (modelo) {
        case "Mercado": {
          switch (accion) {
            case "registrar": {
              this.modal = 1;
              this.tituloModal = "Registrar Ciclos";
              this.tipoAccion = 1;
              break;
            }
            case "actualizar": {
              //console.log(data);
              this.modal = 1;
              this.tituloModal = "Actualizar Ciclos";
              this.tipoAccion = 2;
              this.idDiametro = data["id"];
  ...
  mounted() {
    ...
    this.listarDiametro(1, this.buscar, this.criterio);
  }
};
</script>
<style>
