    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <strong class="lead">Procedimientos de Operación.</strong >
        ...
        <template v-else-if="listado==0">
          <div>
              ...
              >
                <div class="md-layout">
                  ...
                  <div class="md-layout-item">
                   ...
                   <div class="md-layout-item">
                    <md-field>
                      <label>Selecciona un procedimiento</label>
                      <md-select v-model="idRefE" md-dense @input="verComp()">
                        <md-option                          
                  ...
                  <div  v-show="verCo==1">
                    <div class="md-layout-item">
                      <md-field md-clearable>
                        <label for="first-name">Cuantas pruebas Dtex realizaran</label>
                        <md-input
                          name="cant"
                          type="number"
                          id="cant"
                 ...
                 <div class="md-layout" v-show="verCo==2">
                    <div class="md-layout-item">
                      <md-field md-clearable>
                  ...
                  <div class="md-layout"  v-show="verCo==3">
                    <div class="md-layout-item">
                    <md-field md-clearable>
                      <label>Selecciona un Mercado</label>
                    ...
                    <div class="md-layout-item">
                    <md-field md-clearable>
                      <label>Selecciona ahora un Municipio</label>
            ...
            -->
              ...
              <md-step id="second" md-label="Seleccionar Actividades" :md-done.sync="second">
                ...
                <div class="md-layout">
                      ...
                      <h6>
                        <small class="text-muted">Actividades a realizar</small>
                      </h6>
                    </div>
                  <div class="table-responsive col-md-12">         
                    <table class="table table-bordered table-striped table-sm">
                      ...
                      <tr
                        v-for="(objeto, index) in arrayMtoAct"
                        :key="`objeto-${index}`"
                      >                                                
                   ...
                   <div class="d-flex flex-row-reverse">
                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody v-if="arrayEqOp.length">
                          <tr v-for="(objeto,index) in arrayEqOp" :key="`detalle-${index}`">
                            <td v-text="objeto.nombre"></td>
                            <td>
                              <md-button
                                class="md-icon-button md-primary"
                    ...
                    <div class="d-flex flex-row-reverse">
                      <md-button class="md-icon-button md-primary" @click="abrirModal4()">
                        <md-icon>playlist_add_check</md-icon>
                      </md-button>
                      <h6>
                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody v-if="arrayInsOp.length">
                          <tr v-for="(objeto,index) in arrayInsOp" :key="`detalle-${index}`">
                            <td v-text="objeto.nombre"></td>
                            <td>
                              <md-button
                                class="md-icon-button md-primary"
...
export default {
  ...
  methods: {
    ...
    abrirModal4() {
      ...
      this.modal4 = 1;   
      this.tituloModal = "Seleccione Insumos requeridos";
    ...
    getRefE() {
      ...
      var url = "/refequipo/selectRefEquipo?buscar=" + 21;
      axios
        .get(url)
        .then(function(response) {
   ...
   verComp() {
     let me = this;
      if(this.idRefE==51){
        this.verCo=1;
      }else if(this.idRefE==53){
        this.verCo=2;
        this.getTpEstacion();
      }else if(this.idRefE==54){
        this.verCo=3;
        this.getMercado();
      }
      else if(this.idRefE==55){
        this.verCo=3;
        this.getMercado();
      }
      else if(this.idRefE==56){
        this.verCo=3;
        this.getMercado();
      }
      else if(this.idRefE==57){
        this.verCo=3;
        this.getMercado();
      }
