    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Objeto de PQRS
          <button
            type="button"
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered table-striped table-sm">
                ...
                <tbody>
                  <tr v-for="objeto in arrayObjPQRS" :key="objeto.id">
                    ...
                    <md-button class="md-icon-button md-primary " @click="eliminarObjPqr(objeto)" title="Eliminar">
              ...
              <md-card-content>
                <div class="md-layout">
                  <md-field md-clearable>
                    <label>Categoria PQRS</label>
                    <md-select v-model="idCategoria" md-dense>
                      <md-option
...
export default {
  ...
  methods: {
    ...
    listarObjPQRS(page, buscar, criterio) {
      let me = this;
      var url =
        "/objpqrs?page=" +
        page +
      ...
      axios
        ...
        .then(function(response) {
          var respuesta = response.data;
          me.arrayObjPQRS = respuesta.ObjPQRS.data;
    ...
    cambiarPagina(page, buscar, criterio) {
      ...
      me.listarObjPQRS(page, buscar, criterio);
    },
    registrarObjPQRS() {
      let me = this;

      axios
        .post("/objpqrs/registrar", {
  ...
  mounted() {
    this.getCategoria();
    this.listarObjPQRS(1, this.buscar, this.criterio);
  }
};
</script>
<style>
