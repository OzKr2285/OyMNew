    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Gestión de Áreas 
          <button
            type="button"
        ...
        <div class="card-body">
            ...
            <div class="col-md-6">
              <div class="input-group">
                ...
                <input
                  type="text"
                  v-model="buscar"
                  @keyup.enter="listarArea(1,buscar,criterio)"
                  class="form-control"
                  placeholder="Texto a buscar"
                >
                <button
                  type="submit"
                  @click="listarArea(1,buscar,criterio)"
          ...
          <table class="table table-bordered table-striped table-sm">
            ...
            <tbody>
              <tr v-for="objeto in arrayArea" :key="objeto.id">
                <td v-text="objeto.nombre"></td>                

                <td>
                  <md-button class="md-icon-button " @click="abrirModal('Area','actualizar',objeto)" title="Actualizar">                         
                    <i class="material-icons Color3">edit</i>
                  </md-button>
                  <md-button class="md-icon-button md-primary " @click="eliminarArea(objeto)" title="Eliminar">
            ...
            <form action method="post" enctype="multipart/form-data" class="form-horizontal">
              <md-card-content>
                <md-field :class="getValidationClass('nombre')">
                  ...
                  >El nombre del Area es requerido</span>
...
export default {
  ...
  methods: {
    ...
    eliminarArea(data = []) {
      swal({
        title: "Esta seguro de Eliminar el Área " + data["nombre"],
        type: "warning",
      ...
      switch (modelo) {
        case "Area": {
          switch (accion) {
            case "registrar": {
              this.modal = 1;
              this.tituloModal = "Registrar Área";
              this.tipoAccion = 1;
              break;
            }
            case "actualizar": {
              //console.log(data);
              this.modal = 1;
              this.tituloModal = "Actualizar Área";
              this.tipoAccion = 2;
              this.idArea = data["id"];
