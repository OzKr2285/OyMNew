    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Estaciones
            ...
            <div class="form-group row border">
                        ...
                        <div class="form-group row border">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" value="0" step="any" class="form-control" v-model="precio" v-bind="money">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody v-if="arrayDetalle.length">
                                        ...
                                        <tr style="background-color: #CEECF5;">
                                            ...
                                            <td>$ {{totalParcial=((total-totalImpuesto).toLocaleString())}}</td>
                                        </tr>
                                        <tr style="background-color: #CEECF5;">
              ...
              <md-steppers :md-active-step.sync="active" md-linear>
                <md-step
                  ...
                  :md-done.sync="first"
                >
                  <md-autocomplete v-model="nombre" :md-options="countries">
                    <label>Country</label>
                  </md-autocomplete>
