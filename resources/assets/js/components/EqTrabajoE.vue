    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <strong class="lead">Gestión de Equipos de trabajo por Equipo</strong >
          <button
            type="button"
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered table-striped table-sm">
                ...
                <tbody>
                  <tr v-for="objeto in arrayEqEquipoE" :key="objeto.id">                    
                ...
                <div class="table-responsive col-md-12">
                  <table class="table table-bordered table-striped table-sm">
                    ...
                    <tbody v-if="arrayDetInsumos.length">
                      <!-- <tr v-for="(equipo,index) in arrayEqEquipoEquipo" :key="`equipo-${index}`"> -->
...
export default {
  ...
  methods: {
    ...
    listarInsumo(page, buscar, criterio) {
      let me = this;
      var url =
        "/equipo/trabajo?page=" + page + "&buscar=" + buscar + "&criterio=" + criterio;
      axios
        .get(url)
        .then(function(response) {
          var respuesta = response.data;
          me.arrayEqTrabHta = respuesta.equipo.data;
          me.pagination = respuesta.pagination;
        })
        .catch(function(error) {
          console.log(error);
    ...
    agregarDetalleModal(data = []) {
      ...
      if (me.encuentra(data["id"])) {
        swal({
          type: "error",
          title: "Error...",
          text: "Este Equipo y/o Herramienta ya se encuentra agregado!"
        });
      } else {
    ...
    listarInsumoE(page, buscar, criterio) {
      ...
      axios
        ...
        .then(function(response) {
          var respuesta = response.data;
          me.arrayEqEquipoE = respuesta.equipoe.data;
          me.pagination = respuesta.pagination;
        })
        .catch(function(error) {
          console.log(error);
    ...
    listarDetInsumo(page, buscar) {
      ...
      axios
        ...
        .then(function(response) {
          var respuesta = response.data;
          me.arrayDetInsumos = respuesta.equipo.data;
          me.pagination = respuesta.pagination;
        })
        .catch(function(error) {
          console.log(error);
