    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <button
            type="button"
            @click="abrirModal('insumo','registrar')"
            ...
            <div class="col-md-6">
              <div class="input-group">
                ...
                <input
                  type="text"
                  v-model="buscar"
                  @keyup.enter="listarInsumo(1,buscar,criterio)"
                  class="form-control"
          ...
          <table class="table table-bordered table-striped table-sm">
            ...
            <tbody>
              <tr v-for="insumo in arrayInsumo" :key="insumo.id">
                ...
                <td v-text="insumo.desc"></td>

                <td>
                  <md-button class="md-icon-button " @click="abrirModal('insumo','actualizar',insumo)" title="Actualizar">                         
                    <i class="material-icons Color3">edit</i>
                  </md-button>
                  <md-button class="md-icon-button md-primary " @click="eliminarInsumo(insumo)" title="Eliminar">
...
export default {
  ...
  methods: {
   ...
   getInsumo() {
      ...
      var url = "/insumo/selectInsumo";
      axios
        .get(url)
        .then(function(response) {
          //console.log(response);
          var respuesta = response.data;
          me.arrayInsumo = respuesta.insumo;
        })
    ...
    listarInsumo(page, buscar, criterio) {
      ...
      axios
        ...
        .then(function(response) {
          var respuesta = response.data;
          me.arrayInsumo = respuesta.insumo.data;
