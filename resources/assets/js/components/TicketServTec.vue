              ...
              <md-card-content>
                ...
                <template v-if="idObjeto==26">
                  <div class="md-layout">
                    ...
                    <div class="md-layout-item">
                      <md-switch v-model="REE">Requiere Elementos Especiales</md-switch>
                    </div>
                    <div class="md-layout-item">
                      <md-switch v-model="ROE">Requiere Obras Especiales</md-switch>
                    </div>
                  </div>
                  <div class="md-layout">
                    <div class="md-layout-item">
                ...
                <span class="md-caption">Ingrese la solución dada al servicio requerido</span>
    ...
    >
      <div class="modal-dialog modal-dark modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <md-card-actions>
                <md-button type="submit" class="md-dense md-raised md-primary" :disabled="sending" @click="setSolucion()">Registrar</md-button>
...
export default {
  ...
  methods: {
    ...
    abrirModal2() {
      ...
      this.modal2 = 1;
      this.tituloModal = "Ingrese el trabajo realizado";
