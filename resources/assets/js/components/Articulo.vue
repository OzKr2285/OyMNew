            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" @click="abrirModal('articulo','registrar')" class="btn btn-success btn-sm">
                                    ...
                                    <td>
                                        ...
                                        <div v-else>
                                            <span class="badge badge-danger">Desactivado</span>
                                                                            ...
                                                                            <td>
                                        <button type="button" data-tooltip title="Actualizar" @click="abrirModal('articulo','actualizar',articulo)" class="btn btn-warning btn-sm">
                                          <i class="icon-pencil"></i>
                                        </button> &nbsp;
                                        <template v-if="articulo.condicion">
                                            <button type="button" class="btn btn-danger btn-sm" data-tooltip title="Desactivar" @click="desactivarArticulo(articulo.id)">
                                                <i class="icon-trash"></i>
                                            </button>
                                        </template>
                                        <template v-else>
                                            <button type="button" class="btn btn-info btn-sm" data-tooltip title="Activar" @click="activarArticulo(articulo.id)">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    <label class="col-md-2 form-control-label" for="text-input">Categoría</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <barcode :value="codigo" :height=50 :width=1 :options="{ format: 'EAN-13'  }">
                                ...
                                <div class="form-group row">
                                  <label class="col-md-2 form-control-label" for="text-input">Precio Venta</label>
                                    <div class="col-md-6 input-group">
                                        ...
                                        <input type="number" v-model="precio_venta"  placeholder="" class="form-control">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-2 form-control-label" for="text-input">Stock</label>
                                    <div class="col-md-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea class="form-control" v-model="descripcion" aria-label="With textarea"></textarea>
                                    </div>
                                </div>
    ...
    export default {
        ...
        methods : {
            ...
            abrirModal(modelo, accion, data = []){
                ...
                //cuando abra el modal carga el comcobox
