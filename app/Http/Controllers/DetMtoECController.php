...
class DetMtoECController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ->orderBy('oficinas.nombre','asc')->paginate(15);
            ...
            ->select('personas.nombreFull as respo','tp_equipos.nombre','det_mto_ec.id','det_mto_ec.id_mto','oficinas.nombre as nomM','ref_equipos.nombre as tpEquipo','equipos.serial','equipos.desc','equipos.id as idEquipo')
